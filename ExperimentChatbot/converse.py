...
tf.app.flags.DEFINE_integer("to_vocab_size", 1500, "French vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "data/", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "checkpoint/", "Training directory.")
tf.app.flags.DEFINE_string("from_train_data", "data/processed_patient.txt", "Training data.")
tf.app.flags.DEFINE_string("to_train_data", "data/processed_interviewer.txt", "Training data.")
tf.app.flags.DEFINE_string("from_dev_data", "data/processed_patient.txt", "Training data.")
tf.app.flags.DEFINE_string("to_dev_data", "data/processed_interviewer.txt", "Training data.")
...
_buckets = [(1,4), (4,7), (7,10), (10, 13), (13, 16)]
...
def decode(user_input, model, en_vocab, rev_fr_vocab, sess):
    ...
    output = " ".join([tf.compat.as_str(rev_fr_vocab[output]) for output in outputs])
...
def interactive_decode():
  with tf.Session() as sess:
    ...
    #     logging.warning("Sentence truncated: %s", sentence)
      ...
      # If there is an EOS symbol in outputs, cut them at that point.
      if data_utils.EOS_ID in outputs:
        outputs[:] = (value for value in outputs if value != data_utils.EOS_ID)
